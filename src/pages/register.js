...
export default function Register() {
  ...
  const registerButton = async (e) => {
    ...
    //   axios.post('http://localhost:5000/v1/user/signup', payload)
    //   .then(res => {
    //     axios.post('http://localhost:5000/v1/user/login', payload)
    //     .then(res => {
    ...
    // }
    // else {
    //   informationText.current.innerText = 'Password does not match!'
    ...
    if (confirmPasswordInput.current.value === passwordInput.current.value) {
      ...
      let result = await fetch('http://localhost:5000/v1/user/signup', {
        method: 'POST',
        headers: {
          ...
          <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
            <div class="w-full">
              ...
              <label class="block text-sm">
                ...
                <input ref={nameInput} class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray form-input" placeholder="Name" />
              </label>
              <label class="block text-sm">
              ...
              <label class="block text-sm">
                ...
                <input ref={phoneInput} class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray form-input" placeholder="Phone" />
              </label>
              ...
              <label class="block mt-4 text-sm">
                ...
                <input ref={confirmPasswordInput} class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray form-input" placeholder="Type password again" type="password" />
              </label>
              ...
              <button onClick={registerButton} class="block w-full px-4 py-2 mt-4 text-sm font-medium leading-5 text-center text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple" href="./login.html">
                Create account
              </button>
